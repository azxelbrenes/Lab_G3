...
namespace Lab1_G3_.AccesoDatos.Model;

public partial class Lab1_G3Context : DbContext
{
    public Lab1_G3Context()
    {
    }

    public Lab1_G3Context(DbContextOptions<Lab1_G3Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-OPRD7PU\\SQLEXPRESS;Initial Catalog=Lab1_G3;Persist Security Info=True;User ID=progra;Password=1234;MultipleActiveResultSets=False;Encrypt=false;TrustServerCertificate=true;");
